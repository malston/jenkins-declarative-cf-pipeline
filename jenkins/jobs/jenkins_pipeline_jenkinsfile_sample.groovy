...
envs['GIT_EMAIL'] = binding.variables["GIT_EMAIL"] ?: "malston@pivotal.io"
envs['GIT_NAME'] = binding.variables["GIT_NAME"] ?: "Mark Alston"
envs['TOOLS_REPOSITORY'] = binding.variables["TOOLS_REPOSITORY"] ?: 'https://github.com/malston/jenkins-declarative-cf-pipeline'
...
envs['APP_MEMORY_LIMIT'] = binding.variables["APP_MEMORY_LIMIT"] ?: "768m"
