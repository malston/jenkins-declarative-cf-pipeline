...
factory.job('jenkins-pipeline-cf-seed') {
	...
	wrappers {
		parameters {
			...
			stringParam('DEPLOYMENT_ARTIFACT_ID', 'deployment-artifact-id', "Artifact ID of the Maven module or Gradle subproject that you want to deploy")
			...
			stringParam('TOOLS_REPOSITORY', 'https://github.com/malston/jenkins-declarative-cf-pipeline', "The URL containing pipeline functions repository")
